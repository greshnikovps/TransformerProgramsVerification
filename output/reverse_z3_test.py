...
def predicate_0_0_expr(q_position, k_position):
    return Or(
        And(q_position == IntVal(0), k_position == IntVal(2)),
        And(q_position == IntVal(1), k_position == IntVal(6)),
        And(q_position == IntVal(2), k_position == IntVal(4)),
        And(Or(q_position == IntVal(3), q_position == IntVal(4), q_position == IntVal(5)), k_position == IntVal(7)),
        And(Or(q_position == IntVal(6), q_position == IntVal(7)), k_position == IntVal(1)),
    )

def predicate_0_1_expr(q_position, k_position):
    return Or(
        And(Or(q_position == IntVal(0), q_position == IntVal(5)), k_position == IntVal(2)),
        And(Or(q_position == IntVal(1), q_position == IntVal(3)), k_position == IntVal(4)),
        And(Or(q_position == IntVal(2), q_position == IntVal(4)), k_position == IntVal(3)),
        And(Or(q_position == IntVal(6), q_position == IntVal(7)), k_position == IntVal(1)),
    )
...
def predicate_0_2_expr(q_position, k_position):
    return Or(
        And(Or(q_position == IntVal(0), q_position == IntVal(5)), k_position == IntVal(2)),
        And(q_position == IntVal(1), k_position == IntVal(5)),
        And(q_position == IntVal(2), k_position == IntVal(7)),
        And(Or(q_position == IntVal(3), q_position == IntVal(4)), k_position == IntVal(0)),
        And(Or(q_position == IntVal(6), q_position == IntVal(7)), k_position == IntVal(1)),
    )
...
def predicate_0_3_expr(q_position, k_position):
    return Or(
        And(Or(q_position == IntVal(0), q_position == IntVal(5)), k_position == IntVal(2)),
        And(Or(q_position == IntVal(1), q_position == IntVal(2)), k_position == IntVal(5)),
...
def predicate_1_0_expr(q_position, k_position):
    return Or(
        And(Or(q_position == IntVal(0), q_position == IntVal(2), q_position == IntVal(3), q_position == IntVal(7)), k_position == IntVal(0)),
        And(q_position == IntVal(1), k_position == IntVal(6)),
        And(Or(q_position == IntVal(4), q_position == IntVal(5), q_position == IntVal(6)), k_position == IntVal(1)),
    )

def predicate_1_1_expr(q_position, k_position):
    return Or(
        And(Or(q_position == IntVal(0), q_position == IntVal(5), q_position == IntVal(7)), k_position == IntVal(7)),
        And(Or(q_position == IntVal(1), q_position == IntVal(3)), k_position == IntVal(3)),
        And(Or(q_position == IntVal(2), q_position == IntVal(6)), k_position == IntVal(2)),
        And(q_position == IntVal(4), k_position == IntVal(6)),
    )

def predicate_1_2_expr(q_position, k_position):
    return Or(
        And(Or(q_position == IntVal(0), q_position == IntVal(7)), k_position == IntVal(0)),
        And(q_position == IntVal(1), k_position == IntVal(4)),
        And(q_position == IntVal(2), k_position == IntVal(5)),
        And(Or(q_position == IntVal(3), q_position == IntVal(4), q_position == IntVal(6)), k_position == IntVal(1)),
        And(q_position == IntVal(5), k_position == IntVal(2)),
    )

def predicate_1_3_expr(q_position, k_position):
    return Or(
        And(q_position == IntVal(0), k_position == IntVal(4)),
        And(Or(q_position == IntVal(1), q_position == IntVal(6)), k_position == IntVal(3)),
        And(q_position == IntVal(2), k_position == IntVal(2)),
        And(Or(q_position == IntVal(3), q_position == IntVal(4), q_position == IntVal(5), q_position == IntVal(7)), k_position == IntVal(7)),
    )
def mlp_0_0_expr(attn_0_3_output, attn_0_0_output):
    conds = [
        ((StringVal("0"), StringVal("0")), 0),
        ((StringVal("0"), StringVal("1")), 0),
        ((StringVal("0"), StringVal("2")), 0),
        ((StringVal("0"), StringVal("3")), 0),
        ((StringVal("0"), StringVal("4")), 0),
        ((StringVal("0"), StringVal("<s>")), 0),
        ((StringVal("1"), StringVal("0")), 0),
        ((StringVal("1"), StringVal("2")), 0),
        ((StringVal("1"), StringVal("3")), 0),
        ((StringVal("1"), StringVal("4")), 0),
        ((StringVal("1"), StringVal("<s>")), 0),
        ((StringVal("4"), StringVal("0")), 0),
        ((StringVal("4"), StringVal("2")), 0),
        ((StringVal("4"), StringVal("3")), 0),
        ((StringVal("4"), StringVal("4")), 0),
        ((StringVal("4"), StringVal("<s>")), 0),
        ((StringVal("<s>"), StringVal("0")), 0),
        ((StringVal("<s>"), StringVal("<s>")), 0),
        ((StringVal("2"), StringVal("0")), 6),
        ((StringVal("2"), StringVal("</s>")), 6),
        ((StringVal("3"), StringVal("0")), 6),
        ((StringVal("3"), StringVal("</s>")), 6),
        ((StringVal("</s>"), StringVal("4")), 6),
        ((StringVal("</s>"), StringVal("1")), 1),
        ((StringVal("</s>"), StringVal("<s>")), 1),
        ((StringVal("4"), StringVal("</s>")), 3),
        ((StringVal("</s>"), StringVal("0")), 4),
        ((StringVal("0"), StringVal("</s>")), 7),
    ]

    expr = IntVal(5)  # default value
    for (p, t), val in reversed(conds):
        expr = If(And(attn_0_3_output == p, attn_0_0_output == t), val, expr)
    return expr


def mlp_1_0_expr(attn_0_3_output, attn_0_0_output):
    conds = [
        ((StringVal("0"), StringVal("0")), 2),
        ((StringVal("0"), StringVal("1")), 2),
        ((StringVal("0"), StringVal("2")), 2),
        ((StringVal("0"), StringVal("<s>")), 2),
        ((StringVal("1"), StringVal("0")), 2),
        ((StringVal("1"), StringVal("1")), 2),
        ((StringVal("1"), StringVal("2")), 2),
        ((StringVal("1"), StringVal("3")), 2),
        ((StringVal("1"), StringVal("</s>")), 2),
        ((StringVal("1"), StringVal("<s>")), 2),
        ((StringVal("2"), StringVal("1")), 2),
        ((StringVal("2"), StringVal("2")), 2),
        ((StringVal("3"), StringVal("1")), 2),
        ((StringVal("</s>"), StringVal("1")), 2),
        ((StringVal("<s>"), StringVal("0")), 2),
        ((StringVal("<s>"), StringVal("1")), 2),
        ((StringVal("<s>"), StringVal("2")), 2),
        ((StringVal("<s>"), StringVal("3")), 2),
        ((StringVal("<s>"), StringVal("</s>")), 2),
        ((StringVal("<s>"), StringVal("<s>")), 2),
        ((StringVal("1"), StringVal("4")), 6),
        ((StringVal("2"), StringVal("</s>")), 6),
        ((StringVal("4"), StringVal("</s>")), 6),
        ((StringVal("</s>"), StringVal("</s>")), 6),
        ((StringVal("0"), StringVal("</s>")), 4),
...
classifier_weights = pd.read_csv("reverse/reverse_weights.csv", index_col=[0, 1], dtype={"feature": str})
...
def build_pipeline(solver, tokens, position_vars):
    ...
    # === Attention + MLP ===
    outs = {}
    outs["attn_0_0"] = build_attention_block(solver, position_vars, position_vars, predicate_0_0_expr, tokens, "0_0")
    ...
    outs["mlp_0_0"] = build_mlp_block(solver, outs["attn_0_3"], outs["attn_0_0"], mlp_0_0_expr, "0_0")
    outs["attn_1_0"] = build_attention_block(solver, position_vars, position_vars, predicate_1_0_expr, tokens, "1_0")
    outs["attn_1_1"] = build_attention_block(solver, position_vars, position_vars, predicate_1_1_expr, outs["attn_0_2"], "1_1")
    outs["attn_1_2"] = build_attention_block(solver, position_vars, position_vars, predicate_1_2_expr, tokens, "1_2")
    outs["attn_1_3"] = build_attention_block(solver, position_vars, position_vars, predicate_1_3_expr, outs["attn_0_1"], "1_3")
    outs["mlp_1_0"] = build_mlp_block(solver, outs["attn_0_3"], outs["attn_0_0"], mlp_1_0_expr, "1_0")
    # === Логиты ===
...
def is_reversed_inner_z3(orig_seq, out_seq):
    """
    Если мы хотим фиксировать крайние токены, например:
      out_seq[0] == orig_seq[0], out_seq[N-1] == orig_seq[N-1],
    а для внутренних позиций i=1..N-2: out_seq[i] == orig_seq[N-1-i].
    Тогда:
    """
    N = len(orig_seq)
    conds = []
    # фиксируем края:
    conds.append(out_seq[0] == orig_seq[0])
    conds.append(out_seq[N-1] == orig_seq[N-1])
    # внутренние:
    for i in range(1, N-1):
        conds.append(out_seq[i] == orig_seq[N-1-i])
    return And(conds)


def check_always_reversed_output(vocab, N):
    """
    Проверяет: для любого входа длины N (строковые токены),
    с фиксированным tokens[0]=="<s>" и tokens[N-1]=="</s>" и внутренними из vocab,
    выход трансформера (pred_vars) равен реверсу входа.
    Возвращает True, если нет контрпримера, иначе печатает пример и возвращает False.
    Предполагается, что в окружении уже определена функция build_pipeline(solver, tokens, pos),
    а также is_reversed_z3 или is_reversed_inner_z3.
    """
    s = Solver()
    ...
    # 2. Ограничиваем допустимыми токенами из словаря, и фиксируем края:
    for i, tok in enumerate(tokens):
        if i == 0:
            # фиксируем стартовый токен
            s.add(tok == StringVal("<s>"))
        elif i == N - 1:
            # фиксируем конечный токен
            s.add(tok == StringVal("</s>"))
        else:
            # внутренние могут быть любыми из vocab
            s.add(Or([tok == StringVal(v) for v in vocab]))

    # 3. Прогоняем pipeline и получаем переменные предсказания
    _, _, pred_vars = build_pipeline(s, tokens, pos)

    # 4. Добавляем условие, что либо выход НЕ является реверсом входа:
    #    если найдётся такой вход, что выход != реверс(вход), то это контрпример.
    #    То есть формируем:
    #      s.add( is_reversed_z3(...) is False )  <=>  s.add( Not(is_reversed_z3(...)) )
    #    если мы хотим фиксировать края: используем is_reversed_inner_z3.
    cond_rev = is_reversed_inner_z3(tokens, pred_vars)
    # Ищем контрпример: Not(cond_rev)
    s.add(Not(cond_rev))

    # 5. Проверка
    if s.check() == sat:
        m = s.model()
        input_example = [m.evaluate(tok).as_string() for tok in tokens]
        output_example = [m.evaluate(pv).as_string() for pv in pred_vars]
        print("Найден контрпример реверсу!")
        print("Input: ", input_example)
        print("Output:", output_example)
        return False
    else:
        print("Все возможные входы дают реверс-выход.")
        return True


# Пример словаря (внутренних) токенов:
vocab = ["0", "1", "2", "3", "4"]  # или иные допустимые токены
N = 8  # например длина (включая <s> и </s>)

# Запускаем проверку:
res = check_always_reversed_output(vocab, N)
print(res)