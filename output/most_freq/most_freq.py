...
def run(tokens):
    ...
    def mlp_0_0(position, attn_0_3_output):
        ...
        if key in {(1, "1"), (5, "1"), (5, "2"), (5, "3"), (5, "4")}:
            return 6
        elif key in {(0, "<s>"), (3, "<s>"), (4, "<s>"), (5, "<s>"), (7, "<s>")}:
            return 0
        elif key in {(0, "1"), (1, "<s>"), (7, "1")}:
            return 4
        elif key in {(6, "<s>")}:
            return 2
        return 1
    ...
    def mlp_1_0(position, attn_1_2_output):
        ...
        if key in {
            ...
            return 1
        elif key in {(2, "0"), (2, "1"), (2, "2"), (2, "5"), (3, "5")}:
            return 0
        elif key in {(1, "4")}:
            return 2
        elif key in {(2, "3"), (3, "3")}:
